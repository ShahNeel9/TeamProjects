   ...
   // 1). Find Average number of likes per comment.
    ...
    public void avgLIkesPerComment(){
     ...
     /*   Map<Integer,Comment> useLikesCount = DataStore.getInstance().getComments();
        ...
        System.out.println("1. AveLIkes_perComment" + Totallikes/Totalcomments);
    }
  ...
  // 3) Find the post with most comments.
   ...
   // 5). Top 5 inactive users based on total comments they created.
    ...
    public void topFiveInactiveUserByTotalpost(){
        ...
        System.out.println("6.Top Five In active User Overall :");
    ...
    public void topFiveProactiveOverall(){
        ...
        System.out.println("7.Top Five Proactive User Overall:");
        for(int i=0;i<u.size() && i<5; i++){
            System.out.println("   "+u.get(i).getFirstName() +"         "+ u.get(i).getOverAll());
        }
    }
